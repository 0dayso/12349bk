<nav class="mainmenu">
	<div class="container">
		...
		<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
			<li>
				<a href="#head" class="active">主页</a>
			</li>
			<!-- <li>
				<a href="#about">关于楼口12349</a>
			</li>
			<li>
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 text-center">
			...
			<h1 class="title">楼口12349</h1>
			<h2 class="subtitle">欢迎光临楼口12349</h2>

			<!-- Short introductory (optional) -->
			<h3 class="tagline">专业的服务平台</h3>

			<!-- Nice place to describe your site in a sentence or two -->
			<p>
				<a href="../coup/index" class="btn btn-default btn-lg">激活包年券</a>
			</p>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-4 col-sm-offset-2">
				<h5> <strong>Where's my lorem ipsum?
						<br></strong>
				</h5>
				<p>
			...
			<div class="col-sm-4">
				...
				<p>
					<a href="http://be.net/pozhilov9409">Behance</a>
					/
					<a href="https://twitter.com/serggg">Twitter</a>
					/
					<a href="http://linkedin.com/pozhilov">LinkedIn</a>
					/
					<a href="https://www.facebook.com/pozhilov">Facebook</a>
				</p>
			</div>
		</div>
	</div>
...
<!-- 			<div class="col-sm-4 col-sm-offset-2">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p>
							Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque doloribus enim vitae nam cupiditate eius at explicabo eaque facere iste.
						</p>
						<p>
...
<section class="section" id="contact">
	<div class="container">
		...
		<h2 class="text-center title">联系我们</h2>
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2 text-center">
				...
				<ul class="list-inline list-social">
					<li>
						<a href="https://twitter.com/serggg" class="btn btn-link"> <i class="fa fa-twitter fa-fw"></i>
							Twitter
						</a>
					</li>
					<li>
						<a href="https://github.com/pozhilov" class="btn btn-link"> <i class="fa fa-github fa-fw"></i>
							Github
						</a>
					</li>
					<li>
						<a href="http://linkedin/in/pozhilov" class="btn btn-link">
