jQuery(document).ready(function($) {
	...
	var orderTable = jQuery('#waitorders').dataTable({
        ...
        "aoColumns": [
			...
			{ "sTitle": "联系人", "sClass" : "head1", "mDataProp" : "userinfo" },
            ...
            { "sTitle": "服务人员", "sClass" : "head0", "mDataProp" : "staff" },
                        ...
                        buttons: {  
                            "回访完成": function () { 
                                ...
                                if($('.backform').valid()) {
                                    ...
                                    $.post('../order/finish_visit', $('.backform').serialize(), function(data, textStatus, xhr) {
                                        if(data.success) {
                                            that.dialog('close');
                                            jAlert(data.msg);
