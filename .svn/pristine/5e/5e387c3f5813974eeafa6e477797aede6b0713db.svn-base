...
class class_weixin_adv{
    var $appid     = "wxc015c45312ad173d";
    var $appsecret = "e1c27ea61912a52f6552d41979204ae0";
    ...
    public function __construct($appid = NULL, $appsecret = NULL){
        ...
        $this->lasttime     = file_get_contents("./att.txt");
        $this->access_token = file_get_contents("./at.txt");
        ...
        if (time() > ($this->lasttime + 7200)){
            ...
            file_put_contents("./at.txt",$result['access_token']);
            file_put_contents("./att.txt",$this->lasttime);
        }
